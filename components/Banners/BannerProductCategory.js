function BannerProductCategory() {
    return (
            ...
            <div className="container">
                <div className="row gy-4">
                    <div className="col-lg-4 col-md-6">
                        <div className="collection-banner p-bottom p-center text-center">
                            <a href="shop-left-sidebar.html" className="banner-img">
                                <img src="images/fashion/banner/1.jpg" className="bg-img blur-up lazyload" alt="" />
                            </a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="collection-banner p-bottom p-center text-center">
                            <a href="shop-left-sidebar.html" className="banner-img">
                                <img src="images/fashion/banner/2.jpg" className="bg-img blur-up lazyload" alt="" />
                            </a>
                            <div className="banner-detail">
                                <a href="javacript:void(0)" className="heart-wishlist">
                                    <i className="far fa-heart"></i>
                    ...
                    <div className="col-lg-4">
                        <div className="collection-banner p-bottom p-center text-center">
                            <a href="shop-left-sidebar.html" className="banner-img">
                                <img src="images/fashion/banner/3.jpg" className="bg-img blur-up lazyload" alt="" />
                            </a>
                            <div className="banner-detail">
                                <a href="javacript:void(0)" className="heart-wishlist">
                                    <i className="far fa-heart"></i>
