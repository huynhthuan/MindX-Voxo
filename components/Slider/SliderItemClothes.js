...
export default function SliderItemClothes() {
    return (
        <div>
            <div className="home-slider">
                <div className="home-wrap row m-0">
                    <div className="col-xxl-3 col-lg-4 p-0 d-lg-block d-none">
                        <div className="home-left-wrapper">
                            <div>
                                ...
                                <p>
                                    The international hoodies with excellent
                                    durable fabric, not to heavy but simply
                                    PERFECT for Indian summer.
                                </p>
                                <h3>
                                    $49.55{' '}
                                    <span className="theme-color">$49.55</span>
                                </h3>
                    ...
                    <div className="col-xxl-9 col-lg-8 p-0 left-content">
                        <img
                            src="images/fashion/slider/1.jpg"
                        ...
                        <div className="home-content row">
                            <div className="col-xxl-4 col-lg-4 col-md-4 col-sm-5 col-6">
                                <h3>
                                    Sale{' '}
                                    <span className="theme-color">70% OFF</span>
                                </h3>
                                ...
                                >
                                    BUY ONE GET ONE{' '}
                                    <span className="theme-color">FREE</span>
                                </h6>
                                <div
